...
public class SlicingConfigurationDialog extends JPanel {
	...
	@Default private List<DialogSlicerSelector> generalSlicerSelectors = new ArrayList<DialogSlicerSelector>();
	@Default private List<DialogSlicerSelector> targetedSlicerSelectors = new ArrayList<DialogSlicerSelector>();
	@Default private JScrollPane selectedGeneralSlicers = new JScrollPane(new JPanel());
	@Default private JScrollPane selectedTargetedSlicers = new JScrollPane(new JPanel());
...
//		setup the scroll view and add
		...
		this.selectedGeneralSlicers.setMaximumSize(new Dimension(800,400));
		this.selectedGeneralSlicers.setMinimumSize(new Dimension(800,400));
		this.selectedGeneralSlicers.setPreferredSize(new Dimension(800,400));
	...
	public SlicingConfiguration generateConfig() {
		...
		for(DialogSlicerSelector maker: this.targetedSlicerSelectors) {
			String targeter = maker.getTarget();
		...
		return SlicingConfiguration.builder()
				.generalSlicers(general)
				.targetedSlicers(target)
				.build();
	}
